...
Using k-fold cross validation, we will check the fit of our regression model
...
The average R^2^ value for our K-fold cross validation was `{r} mean(res)` meanwhile, the R^2^ value for our 
