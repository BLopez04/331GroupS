...
To explore the relationship between poverty rate and life expectancy, we start with a scatterplot of the average values for each country across all years. We then animate the relationship over time to observe how the connection between the two variables evolves historically.
